...
export const REPOS = [
  {
    ...
    branch: 'main',
    id: 1,
    description: 'Enterprise-grade server backbone for Unified Banking Services. Optimized for high-concurrency transactions and scalable database clustering.',
    language: 'TypeScript',
    ...
    primaryColor: '#67df70',
    languageStats: [
    { name: 'TypeScript', pct: 70.2, color: '#3178c6' },
    { name: 'JavaScript', pct: 25.3, color: '#f1e05a' },
    { name: 'Other', pct: 4.5, color: '#8b949e' },
    ],
    pendingCommits: 12,
  },
  {
    ...
    branch: 'main',
    id: 2,
    description: 'Hospital Management System providing patient records, billing, and scheduling workflows for clinic networks. HIPAA compliant storage modules.',
    language: 'React',
    ...
    primaryColor: '#026ee4',
    languageStats: [
    { name: 'React', pct: 62.4, color: '#61dafb' },
    { name: 'JavaScript', pct: 33.1, color: '#f1e05a' },
    { name: 'Other', pct: 4.5, color: '#8b949e' },
    ],
    pendingCommits: 5,
  },
  {
    ...
    branch: 'main',
    id: 3,
    description: 'Fast, scalable REST API for spiritual content delivery. Features global edge caching and 50+ language support via GraphQL.',
    language: 'JavaScript',
    ...
    primaryColor: '#ff7a6f',
    languageStats: [
    { name: 'JavaScript', pct: 81.6, color: '#f1e05a' },
    { name: 'Other', pct: 18.4, color: '#8b949e' },
    ],
    pendingCommits: 3,
  },
  {
    ...
    branch: 'main',
    id: 4,
    description: 'Technical documentation and architectural blueprints for the Unified Banking Services ecosystem, including dev guides and API specs.',
    language: 'Markdown',
    ...
    primaryColor: '#7f8ea5',
    languageStats: [
    { name: 'Markdown', pct: 94.0, color: '#083fa1' },
    { name: 'Other', pct: 6.0, color: '#8b949e' },
    ],
    pendingCommits: 0,
  },
];
